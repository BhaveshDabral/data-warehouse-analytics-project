...
BEGIN
    ...
    FROM 'G:/sqlwork/New folder/warehouse/sql-data-warehouse-project/datasets/source_crm/cust_info.csv'
    DELIMITER ','
	CSV HEADER;
	...
	FROM'G:/sqlwork/New folder/warehouse/sql-data-warehouse-project/datasets/source_crm/prd_info.csv'
    DELIMITER ','
	CSV HEADER;
    ...
    FROM 'G:/sqlwork/New folder/warehouse/sql-data-warehouse-project/datasets/source_crm/sales_details.csv'
    DELIMITER ','
	CSV HEADER;
    ...
    FROM 'G:/sqlwork/New folder/warehouse/sql-data-warehouse-project/datasets/source_erp/CUST_AZ12.csv'
    DELIMITER ','
	CSV HEADER;
    ...
    FROM 'G:/sqlwork/New folder/warehouse/sql-data-warehouse-project/datasets/source_erp/LOC_A101.csv'
    DELIMITER ','
	CSV HEADER;
    ...
    FROM 'G:/sqlwork/New folder/warehouse/sql-data-warehouse-project/datasets/source_erp/PX_CAT_G1V2.csv'
    DELIMITER ','
	CSV HEADER;
